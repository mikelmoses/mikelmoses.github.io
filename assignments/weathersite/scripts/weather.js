...
request.open('GET', 'https://api.openweathermap.org/data/2.5/weather?id=5604473&appid=3da6c32fc144856c7600d0fa1baf603d&units=imperial', true);
request.send();
...
request5day.open('GET', 'https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=3da6c32fc144856c7600d0fa1baf603d&units=imperial', true);
request5day.send();
