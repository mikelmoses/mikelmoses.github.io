...
request.onload = function() {
    //here i must put the code to load the data to the page
    // this code executes after 
    console.log(request.response);
    console.log(request.response.towns[0].yearFounded);
    //console.log(request.response.towns[1].yearFounded);

// document.getElementById("yearFounded").innerHTML = "hello";
